...
import { postRequest, getRequest } from '../Components/config';
import "../dist/styles/login.scss";
import { events } from '../models/favourites.js';

const LoginPage = function ({propVal}:{propVal: string}) {
    console.log(propVal);
    ...
    const a:number = 22;
    // nested function 1
    const handleSubmit = function(e:React.FormEvent, n:string, p:string) {
        e.preventDefault();
        const body = {
            username: n,
            password: p
